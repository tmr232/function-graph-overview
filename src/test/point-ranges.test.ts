...
test("Basic Range Test", () => {
    ...
    ranges = addRange(ranges, { row: 10, column: 10 }, { row: 20, column: 20 }, "B",);
    ranges = addRange(ranges, { row: 30, column: 30 }, { row: 40, column: 40 }, "C",);
...
test("Add to same start", () => {
    ...
    ranges = addRange(ranges, { row: 10, column: 10 }, { row: 60, column: 60 }, "B",);
    ranges = addRange(ranges, { row: 10, column: 10 }, { row: 40, column: 40 }, "C",);
